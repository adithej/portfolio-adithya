...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-16 gap-y-8 mt-16">
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {iconLists.map((icon, index) => (
                    <div
                      key={icon}
                      className="border border-white/[0.2] rounded-full bg-black lg:w-10 ld:h-10
